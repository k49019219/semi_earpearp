 select V.idx, V.boardno, V.prodcode, V.title, V.writeday, B.name
 from 
 ( 
...
delete from san_review where revidx = '49';

rollback;

update san_qna set qnaidx = '23'
where qnaidx = '25';

delete from san_admincomment where fk_qnaidx = '20';
