...
<style type="text/css">
	...
	#wrap_superInfo #container {
		margin: 0 auto;
	}
	
	#wrap_superInfo .title_area {
		margin: 53px 0 50px;
		text-align: center;
	}
	
	#wrap_superInfo .title_area h2 {
...
<body>
	<div id="wrap_superInfo">
		<div id="container">
			...
			<div class="privacy">
				 <p>** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 
				 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한 내용을 반영하여 사용하시기 바랍니다. **</p>
				 
				 <p>(주)○○○은 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
				 <br>
				 ...
				 &nbsp;회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 oo년간 회원의 정보를 보유할 수 있습니다. </p>
				 ...
				 o&nbsp;위탁 대상자 : [택배사 이름]<br>
				 o&nbsp;위탁업무 내용 : [택배사 위탁 내용]</p>
				 
				 <p>o&nbsp;위탁 대상자 : [PG사 이름]<br>
				 o&nbsp;위탁업무 내용 : [PG사 위탁 내용]</p>
				 
				 <p><br>■ 이용자 및 법정대리인의 권리와 그 행사방법<br>
				 ...
				 2.&nbsp;설정방법 예(인터넷 익스플로어의 경우) : 웹 브라우저 상단의 도구 &gt; 인터넷 옵션 &gt; 개인정보<br>3.&nbsp;단, 귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에 어려움이 있을 수 있습니다.</p>
				 ...
				 개인정보침해신고센터 (<a href="http://privacy.kisa.or.kr">www.privacy.kisa.or.kr</a> / 국번 없이 118)<br>
				 대검찰청 사이버범죄수사단 (<a href="http://www.spo.go.kr/site/spo/02/10206010000002018100812.jsp">www.spo.go.kr</a> / 국번 없이 1301)<br>
				 경찰청 사이버안전국 (<a href="https://cyberbureau.police.go.kr">www.cyberbureau.police.go.kr</a> / 국번 없이 182)<br></p>
			</div>
		</div>
	</div>
